...
train_data = pd.read_csv('../dataset/training_label_attacktype.csv', low_memory=False, encoding="gbk",index_col=0)
print(train_data.shape)

test_data = pd.read_csv('../dataset/testing_label_attacktype.csv', low_memory=False,encoding="gbk",index_col=0)
